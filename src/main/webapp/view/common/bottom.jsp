...
<script src="./res/plugin/jquery/jquery-1.11.2.min.js"></script>
<script src="./res/plugin/bs/js/bootstrap.js"></script>
<script src="./res/plugin/bootpag/jquery.bootpag.min.js"></script>
